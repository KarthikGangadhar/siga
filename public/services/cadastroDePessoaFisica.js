angular
    .module('main')
    .factory('cadastroDePessoaFisica', [
        function cadastroDePessoaFisicaFactory() {
            'use strict';
            var validar = function validar(sequencia) {
                    var add,
                        i,
                        rev;
                    if (sequencia === '') {
            ...
            return function cadastroDePessoaFisica(sequencia) {
                ...
                throw 'Este serviço aceita um parâmetro String ou nenhum parâmetro (undefined). Recebeu [' + typeof sequencia + '].';
            };
        }
    ]);
